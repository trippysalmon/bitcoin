...
class BitcoinTestFramework(object):
    ...
    def start_node(self, i, dirname, extra_args=None, rpchost=None, timewait=None, binary=None, stderr=None):
        ...
        node = TestNode(i, dirname, extra_args, self.chain, rpchost, timewait, binary, stderr, self.mocktime, coverage_dir=self.options.coveragedir)
        node.start()
    ...
    def start_nodes(self, num_nodes, dirname, extra_args=None, rpchost=None, timewait=None, binary=None):
        ...
        try:
            for i in range(num_nodes):
                nodes.append(TestNode(i, dirname, extra_args[i], self.chain, rpchost, timewait=timewait, binary=binary[i], stderr=None, mocktime=self.mocktime, coverage_dir=self.options.coveragedir))
                nodes[i].start()
            for node in nodes:
                node.wait_for_rpc_connection()
        except:
    ...
    def _initialize_chain(self, test_dir, num_nodes, cachedir):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                self.nodes.append(TestNode(i, cachedir, extra_args=[], chain=self.chain, rpchost=None, timewait=None, binary=None, stderr=None, mocktime=self.mocktime, coverage_dir=None))
