    ...
    fFeeMinimized(true)
{
    ...
    if (!settings.contains("nTransactionFee"))
        settings.setValue("nTransactionFee", (qint64)DEFAULT_TRANSACTION_FEE.n);
...
void SendCoinsDialog::setModel(WalletModel *model)
{
    ...
    if(model && model->getOptionsModel())
    {
        ...
        ui->customFee->setSingleStep(CWallet::minTxFee.GetFeePerK().n);
...
SendCoinsDialog::~SendCoinsDialog()
{
    ...
    settings.setValue("nTransactionFee", (qint64)ui->customFee->value().n);
...
void SendCoinsDialog::setMinimumFee()
{
    ...
    ui->customFee->setValue(CWallet::minTxFee.GetFeePerK().n);
}
