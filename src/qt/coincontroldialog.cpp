...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    if (nQuantity > 0)
    {
        ...
        // Priority
        double mempoolEstimatePriority = mempool.estimateSmartPriority(nTxConfirmTarget, nGlobalMempoolSizeLimit);
    ...
    if (payTxFee.GetFeePerK() > 0)
        ...
        dFeeVary = (double)std::max(CWallet::GetRequiredFee(1000), mempool.estimateSmartFee(nTxConfirmTarget, nGlobalMempoolSizeLimit).GetFeePerK()) / 1000;
    }
