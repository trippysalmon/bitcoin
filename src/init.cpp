...
{
    const std::unique_ptr<CChainParams> defaultChainParams(CChainParams::Factory(CBaseChainParams::MAIN));
    const std::unique_ptr<CBaseChainParams> defaultBaseParams(CBaseChainParams::Factory(CBaseChainParams::MAIN));
    const std::unique_ptr<CChainParams> testnetChainParams(CChainParams::Factory(CBaseChainParams::TESTNET));
    const std::unique_ptr<CBaseChainParams> testnetBaseParams(CBaseChainParams::Factory(CBaseChainParams::TESTNET));
