...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    BOOST_CHECK(policy.AreInputsStandard(txTo, coins));
    ...
    BOOST_CHECK(!policy.AreInputsStandard(txToNonStd1, coins));
    ...
    BOOST_CHECK(!policy.AreInputsStandard(txToNonStd2, coins));
