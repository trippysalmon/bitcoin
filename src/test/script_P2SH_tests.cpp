...
BOOST_AUTO_TEST_CASE(sign)
{
    ...
    BOOST_CHECK(Policy("standard").CheckTxPreInputs(txFrom, reason));
...
BOOST_AUTO_TEST_CASE(set)
{
    ...
    {
        BOOST_CHECK_MESSAGE(SignSignature(keystore, txFrom, txTo[i], 0), strprintf("SignSignature %d", i));
        BOOST_CHECK_MESSAGE(Policy("standard").CheckTxPreInputs(txTo[i], reason), strprintf("txTo[%d].IsStandard", i));
    }
}
...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    BOOST_CHECK(Policy("standard").CheckTxWithInputs(txTo, coins));
    ...
    BOOST_CHECK(!Policy("standard").CheckTxWithInputs(txToNonStd1, coins));
    ...
    BOOST_CHECK(!Policy("standard").CheckTxWithInputs(txToNonStd2, coins));
