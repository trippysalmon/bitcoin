...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    ...
    const std::unique_ptr<CChainParams> testChainParams(CChainParams::Factory(CBaseChainParams::MAIN));
    const Consensus::Params &mainnetParams = testChainParams->GetConsensus();
