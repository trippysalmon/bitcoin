...
public:
    CMainParams() {
        ...
        consensus.fPowSkipProofOfWorkCheck = false;
        /** 
...
public:
    ...
    virtual void setSkipProofOfWorkCheck(bool afSkipProofOfWorkCheck) { consensus.fPowSkipProofOfWorkCheck = afSkipProofOfWorkCheck; }
};
