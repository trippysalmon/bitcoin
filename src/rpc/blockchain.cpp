...
static UniValue SoftForkMajorityDesc(int version, CBlockIndex* pindex, const Consensus::Params& consensusParams)
{
    ...
    {
        case 2:
            activated = pindex->nHeight >= consensusParams.nOldDeploymentHeights[Consensus::BIP34_HEIGHT_ACTIVE];
            break;
        case 3:
            activated = pindex->nHeight >= consensusParams.nOldDeploymentHeights[Consensus::BIP66_HEIGHT_ACTIVE];
            break;
        case 4:
            activated = pindex->nHeight >= consensusParams.nOldDeploymentHeights[Consensus::BIP65_HEIGHT_ACTIVE];
            break;
    }
