                        ...
                        bool* pfMissingInputs, bool fRejectAbsurdFee)
{
...

    {
        ...
        if (nFees < 0) // Redundant in Consensus::CheckTxInputs called twice later
        ...
        if (fLimitFree && nFees < ::minRelayTxFee.GetFee(nSize) + nFeesDeleted && GetMinRelayFee(tx, nSize, true) != 0)
