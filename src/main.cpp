 ...
 */
static bool AcceptMempoolReplacement(const CTransaction& tx, CValidationState& state, const set<uint256>& setConflicts, CTxMemPool::setEntries& allConflicting, CAmount& nConflictingFees, size_t& nConflictingSize, CTxMemPool& pool, const CAmount& nFees, const size_t nSize, const uint256& hash)
{
                        ...
                        bool* pfMissingInputs, bool fOverrideMempoolLimit, bool fRejectAbsurdFee)
{
...

    {
        ...
        LOCK(pool.cs);
        if (!AcceptMempoolReplacement(tx, state, setConflicts, allConflicting, nConflictingFees, nConflictingSize, pool, nFees, nSize, hash))
            return false;
