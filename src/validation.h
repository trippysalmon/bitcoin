...
bool LoadExternalBlockFile(const CChainParams& chainparams, const int64_t flags, FILE* fileIn, CDiskBlockPos *dbp = NULL);
...
bool ConnectBlock(const CBlock& block, CValidationState& state, const int64_t flags, CBlockIndex* pindex, CCoinsViewCache& coins,
