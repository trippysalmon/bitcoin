 ...
 */
bool VerifyTx(const CTransaction& tx, CValidationState& state, const unsigned int flags, const int nHeight, const int64_t nMedianTimePast, const int64_t nBlockTime, const CUtxoView& inputs, CAmount& nFees, int64_t& nSigOps);
