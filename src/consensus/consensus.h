 ...
 */
bool VerifyBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, const CBlockIndex* pindexPrev, VersionBitsCache& versionbitscache, const int64_t nHeight, const int64_t nMedianTimePast, int64_t nAdjustedTime, const CCoinsViewCache& inputs, const int64_t nSpendHeight, bool fScriptChecks, bool cacheStore);
